...
import { updateHospital, addDoctor, allDoctors, updateDoctor, deleteDoctor, loginAdmin, appointmentsAdmin, appointmentCancel, adminDashboard, getSettings, updateSettings, getPendingHospitals, getAllHospitals, approveHospital, rejectHospital, updateHospitalTrialPeriod, getAppointmentRequests, updateAppointmentRequestStatus, getContactMessages, updateContactMessageStatus, getNewsletterSubscribers, getAllUserEmails, sendPromotionalEmail, createAnnouncement, getAllAnnouncements, getActiveAnnouncements, updateAnnouncement, deleteAnnouncement, getAllUsers, createUserAdmin, updateUserAdmin, deleteUserAdmin, exportUsersCsvAdmin, importUsersCsvAdmin, getDoctorApprovals, approveDoctor, rejectDoctor, updateDoctorApproval, deleteDoctorApproval, getAllLabs, deleteLab, deleteHospital, deletePharmacy } from '../controllers/adminController.js'
...
import { addLab, updateProfile as updateLabProfile } from '../controllers/labController.js'
...
adminRouter.put('/hospitals/:hospitalId', authAdmin, updateHospital)
adminRouter.post('/hospital/:hospitalId/approve', authAdmin, approveHospital)
...
adminRouter.delete('/hospitals/:hospitalId', authAdmin, deleteHospital)
...
adminRouter.delete('/pharmacies/:id', authAdmin, deletePharmacy)

// Lab management routes
adminRouter.post('/labs', authAdmin, addLab)
adminRouter.get('/labs', authAdmin, getAllLabs)
adminRouter.put('/labs/:id', authAdmin, updateLabProfile)
adminRouter.delete('/labs/:id', authAdmin, deleteLab)
