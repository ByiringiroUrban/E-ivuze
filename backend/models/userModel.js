...
const userSchema = new mongoose.Schema(
  {
    ...
    insurance: {
      provider: { type: String, enum: ['Mutuelle', 'RAMA', 'MMI', 'Private', 'None'], default: 'None' },
      policyNumber: { type: String, default: null },
      expiryDate: { type: Date, default: null },
      insuranceExpiration: { type: String, default: null },
    ...
    languagePreference: { type: String, enum: ['Kinyarwanda', 'English', 'French'], default: 'English' },
